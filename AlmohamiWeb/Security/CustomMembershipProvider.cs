...
namespace AlmohamiWeb.Security
{
    public class CustomMembershipProvider : MembershipProvider
    {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            User user = AuthenticateUser.AuthenticateUserData(username, password);
            if (user != null)
            {
        ...
        public override MembershipUser GetUser(string email, bool userIsOnline)
        {
            ...
            {
                return new MembershipUser("MyMembershipProvider", email,
                          AuthenticateUser.User.UserId, AuthenticateUser.User.UserName, null,
